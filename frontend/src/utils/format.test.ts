...
describe("formatReleaseDate", () => {
  ...
  it("marks a released date as liberado", () => {
    expect(formatReleaseDate("2026-08-25T13:04:21.000000Z", true)).toBe("25/08/2026, 10:04 (liberado)");
  });

  it("marks a pending date as previsto", () => {
    expect(formatReleaseDate("2026-08-25T13:04:21.000000Z", false)).toBe("25/08/2026, 10:04 (previsto)");
  });
  ...
  it("formats in Brasília time regardless of the local timezone", () => {
    ...
    expect(formatReleaseDate("2026-01-01T23:30:00.000000Z", false)).toBe("01/01/2026, 20:30 (previsto)");
  });
});
