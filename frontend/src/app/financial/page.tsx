    ...
    <div className={listStyles.page}>
      <div className={listStyles.container}>
                    ...
                    <tbody>
                      {reconciliation.map((row) => (
                        <tr key={row.order_id}>
                          ...
                          <td style={{ color: "var(--color07)" }}>{formatCurrency(row.difference)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <div className={listStyles.section}>
          ...
          <Pagination currentPage={meta.current_page} lastPage={meta.last_page} total={meta.total} onChange={setPage} />
        </div>
        </SessionGuard>
      </div>
    </div>
