        ...
        <SessionGuard>
          <div className={listStyles.header}>
            <div>
              ...
              <p className={listStyles.subtitle}>Perguntas e conversas de pós-venda do Mercado Livre.</p>
            </div>
                ...
                conversations.map((conversation) => (
                  ...
                  >
                    <div className={styles.conversationTop}>
                      <span className={styles.conversationBuyer}>{conversation.buyer_nickname ?? "—"}</span>
